...
- “素材精选”只看结果和资产：低粉爆款、监控账号跑出来的内容都汇总到这里，重点展示标题、互动、原视频、无水印视频、口播文稿、字幕、报告和拆解价值；这里不维护账号池。
- “监控账号”只管来源和批次：维护账号池、启停账号、每账号抓几条、是否下载视频、是否提取口播文稿；跑出的作品进入“素材精选”和飞书结果库。
- 低粉爆款和账号监控不能只按播放/点赞理解，要结合 IP 操盘方法生成轻量判断：是否服务明确业务/账号、能否提炼一句话选题、是否有证据素材、是否需要人工审美判断。页面和飞书可选字段都应复用同一套 `ip_operation` 结果。
